        ...
        <>
            <div className='flex items-center justify-center'>
                <div className='w-[100vw] h-screen px-5 py-10 pb-15 md:w-100 xl:border-1 xl:border-gray-300 flex flex-col gap-4 bg-[#F7F8F9]'>
                    ...
                    <form action="" className='flex flex-col gap-4' onSubmit={handleData}>
                        ...
                        <button type="submit" className='bg-[#6C25FF] text-white w-full text-xl font-semibold py-3 rounded-[10px] border-none bold cursor-pointer' >login</button>
                    </form>
                </div>
            </div>
        </>
